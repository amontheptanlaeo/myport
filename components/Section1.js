...
function Section1({myHome}) {
  return (
    <div ref={myHome} className='h-screen bg-black text-white flex justify-center items-center rounded-bl-[10rem] sm:rounded-bl-[20rem] md:rounded-bl-[45rem]  overflow-hidden mb-10 md:mb-20 transition-all duration-300 ease-linear'>
      ...
      <motion.div initial={{scale:0}} drag dragConstraints={{top:0 , right:0 , left:0, bottom:0}} animate={{scale:1,y:[0,20,0]}} transition={{duration:1.2 }} className='absolute right-30 sm:right-32 flex justify-center items-center text-white bg-[#8400ff] cursor-grabbing rounded-3xl pl-10 pr-10 pt-5 pb-5 font-bold transition-all duration-300 ease-linear'>
        <div>
          <h1 className='text-[12px] sm:text-[16px] text-black transition-all duration-300 ease-linear'><span className='text-[20px] sm:text-[20px] transition-all duration-300 ease-linear'>My</span> name is <span className='text-white'>Amonthep Tanlaeo</span></h1>
